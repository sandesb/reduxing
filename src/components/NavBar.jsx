    ...
    return (
      <Link
        ...
        className={`flex items-center space-x-2 py-3 px-2 rounded-md text-gray-600 ${
          isExactActive ? 'bg-sidebar-active text-gray-600' : 'hover:bg-sidebar-active'
        } transition`}
      >
    ...
    >
      <div className="h-full  bg-primary-bg w-full">
        <div className="flex items-center justify-center py-4 mb-2">
          <img src={dp} alt="Profile" className="w-12 h-12 rounded-full border-2 border-blue-200 shadow-md" />
        </div>
