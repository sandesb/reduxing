...
const InputField = ({ type, value, onChange, label, customWidth, smCustomWidth }) => {
  return (
    <div className={`relative ${smCustomWidth} w-full sm:w-full md:${customWidth}`}> {/* Use responsive classes */}
      {type === 'emoji' ? (
