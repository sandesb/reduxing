...
const Repositories = () => {
  ...
  return (
    ...
    <div className="flex flex-wrap items-center gap-4 mb-6">
      ...
      <div className="relative flex-grow max-w-md">
        <input
          ...
          className="rounded-full px-5 py-2 pl-10 bg-gray-50 text-gray-500 placeholder-gray-400 shadow-sm border border-gray-300 w-full focus:outline-none focus:ring-2 focus:ring-blue-200"
        />
    ...
    {/* Repository Cards */}
    <div className="repository-cards flex flex-wrap space-x-4">
